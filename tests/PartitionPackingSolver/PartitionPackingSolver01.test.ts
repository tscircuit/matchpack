...
const STATIC_INPUT: PartitionPackingSolverInput = {
  ...
  resolvedLayout: {
    chipPlacements: {
      ...
      R5: { x: 18.576130685499997, y: -0.6528779266786373, ccwRotationDegrees: 0 },
  ...
  laidOutPartitions: [
    ...
    {
      chipMap: {
        R7: { chipId: "R7", pins: ["R7.1", "R7.2"], size: { x: 0.40790845000000175, y: 1.0583332999999997 } },
        Q1: { chipId: "Q1", pins: ["Q1.1", "Q1.2", "Q1.3"], size: { x: 0.8935117710000002, y: 1.1601665819999987 } },
      },
      chipPinMap: {
        "R7.1": { pinId: "R7.1", offset: { x: -0.0002732499999993365, y: -0.5512907000000005 }, side: "y-" },
        "R7.2": { pinId: "R7.2", offset: { x: 0.0002732499999993365, y: 0.5512907000000002 }, side: "y+" },
        "Q1.1": { pinId: "Q1.1", offset: { x: 0.30397715550000004, y: 0.5519248499999994 }, side: "y+" },
        "Q1.2": { pinId: "Q1.2", offset: { x: 0.31067575550000137, y: -0.5519248499999994 }, side: "y-" },
        "Q1.3": { pinId: "Q1.3", offset: { x: -0.4185974445, y: -0.10250625000000019 }, side: "x-" },
      },
      groupMap: {},
      groupPinMap: {},
      netMap: {
