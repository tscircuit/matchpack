...
import { rotatePinSide } from "lib/utils/rotatePinSide"
...
export const findSameSidePassiveGroups = (
  ...
  for (const [passiveChipId, passiveChip] of Object.entries(problem.chipMap)) {
    ...
    // An off-center pin on a tall chip can point radially toward a different
    // edge. Its declared facing direction is the rail bank's attachment side.
    const side = rotatePinSide(mainPin.side, mainChipRotation)
